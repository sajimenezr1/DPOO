...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el pa�s de un atleta dado");
	}
	private void ejecutarAtletaPais()
	{
		System.out.println("\n" + "Dar el pais de un atleta" + "\n");
		String nombreAtleta = input("Por favor ingrese el nombre del atleta a consultar");
		String respuesta = calculadora.atletaPais(nombreAtleta);
		System.out.println("El pais del atleta es " + respuesta);
	}
	/**
